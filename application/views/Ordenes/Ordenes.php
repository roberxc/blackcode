...
<div class="content-wrapper">
   ...
   <div class="card">
                        ...
                        <table class="table table-head-fixed text-nowrap">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td><button type="button" class="btn btn-default"><i data-toggle="modal" 
                                    data-target="#detalleorden" class="fas fa-align-left"></i></button>
      ...
      <div class="modal fade" id="detalleorden">
