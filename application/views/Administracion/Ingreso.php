      ...
      <div class="modal-dialog modal-lg">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <h4 class="modal-title">Caja chica ingreso</h4>
            ...
            <div class="modal-footer justify-content-between">
               <button type="button" class="btn btn-primary" onclick="updateCajaChica()" data-toggle="modal"
   ...
   $(document).ready(function(){
     $('#tabla_ingreso').DataTable({
      dom: 'Bfrtip',
       ...
       "processing": true,
       "serverSide": true, 
       "ajax":{url:"<?php echo base_url('Administracion/obtenerIngresosCajaChica'); ?>",
       type: "POST"
     },
       "columnDefs":[
         {
