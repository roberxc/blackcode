      ...
      <div class="card-body box-profile">
         <div class="text-center">
            <img class="profile-user-img img-fluid img-circle"
               src="<?php echo base_url();?>assets/dist/img/combus.png"
         ...
         <ul class="list-group list-group-unbordered mb-3">
            <li class="list-group-item">
               <b>Existencia total</b> <a
                  class="float-right"><?php if(isset($total_BoletasC)){ echo $total_BoletasC[0]['total'];}else{echo"0";}?></a>
            </li>
         </ul>
...
<div class="card">
   ...
   <!-- /.card-header -->
   <form id="form-subir-formcombustible" style="padding:0px 15px;" class="form-horizontal" role="form" action="<?php echo base_url();?>Administracion/registroCombustible" method="POST">
      <div class="card-body">
         <div class="tab-content">
            <div class="active tab-pane" id="settings">
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <input type="date" min="2021-01-01"
                        ...
                        data-inputmask="'alias': 'ip'" data-mask id="fecha" name="fecha">
                  </div>
               </div>
               <div class="form-group row">
               ...
               <div class="form-group row">
                  <label for="inputName" class="col-sm-2 col-form-label">Conductor
                  </label>
                  <div class="col-sm-10">
                     <input type="text" maxlength="50" style="text-transform:lowercase;"
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <input type="text" maxlength="30" style="text-transform:lowercase;"
                        class="form-control" data-inputmask="'alias': 'ip'" data-mask
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <input type="number" min="0" step="1" maxlength="10"
                        ...
                        data-inputmask="'alias': 'ip'" data-mask id="litros" name="litros">
                  </div>
               </div>
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <input type="number" min="0" step="1" maxlength="10"
                        style="text-transform:lowercase;" class="form-control"
                        data-inputmask="'alias': 'ip'" data-mask id="valor" name="valor">
                  </div>
               </div>
               <hr class="mt-3 mb-3" />
