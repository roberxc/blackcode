                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="active tab-pane" id="settings">
                                        <form id="formcombustible" style="padding:0px 15px;" class="form-horizontal"
                                            role="form">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="date" min="2021-01-01"
                                                        ...
                                                        data-inputmask="'alias': 'ip'" data-mask id="fecha">
                                 ...
                                 ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="number" min="0" step="1" maxlength="10"
                                                        ...
                                                        data-inputmask="'alias': 'ip'" data-mask id="litros">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="number" min="0" step="1" maxlength="10"
                                                        style="text-transform:lowercase;" class="form-control"
                                                        data-inputmask="'alias': 'ip'" data-mask id="valor">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-3 text-center">
                                            <button type="submit" id="addcombustible"
                                ...
                                <script src="<?php echo base_url()?>assets/js/ModoCombustible/registro_combustible.js">
                                </script>
                                </body>
