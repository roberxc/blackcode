...
<body class="hold-transition sidebar-mini">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3">
                     ...
                     <div class="form-group">
                        ...
                        <button type="button" class="btn btn-block btn-primary" id="filtrado">Filtrar</button>
                     </div>
                     <!-- /.form-group -->
                  </div>
                  <!-- /.col -->
   ...
   <script src="<?php echo base_url()?>assets/js/CajaChica/informe_egresos.js"></script>
</body>
</html>