...
<div class="content-wrapper">
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">Documento pago</h1>
            </div>
            <div class="col-sm-6">
         ...
         <div class="table-responsive">
            ...
            <div class="modal-content">
               <div class="modal-header bg-blue">
                  <H3>Ingresar nuevo documento pago</H3>
                  <button type="button" class="close-white" data-dismiss="modal">&times;</button>
               </div>
               <div class="modal-body">
                  <form id="form-subir-documentopago" style="padding:0px 15px;" class="form-horizontal" role="form" action="<?php echo base_url();?>ComprobantePago/subirDocumentoPago" method="POST">
                     <div class="row">
                        <div class="col-md-4">
                           <div class="form-group">
                              <label for="recipient-tipo" class="col-form-label">Numero documento</label>
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <select name="nrofactura" id="nrofactura" style="width: 100%; height: 60%">
                              <option value="" selected>Seleccione</option>
                              <?php
                              
                                 foreach($lista_facturas as $i){
                                   echo '<option value="'. $i->id_facturas .'">'. $i->nrofactura .'</option>';
                                 }
      ...
      dom: 'Bfrtip',
        buttons: [
            ...
            },
            {
               ...
               title:      'Cotizacion CDH INGENIERIA',
       ...
       "processing": true,
       "serverSide": true, 
       "ajax":{url:"<?php echo base_url('ComprobantePago/obtenerDocumento'); ?>",
       type: "POST"
     },
       "columnDefs":[
         {
...
<script src="<?php echo base_url();?>assets/js/Administracion/comprobante_pago.js"></script>
