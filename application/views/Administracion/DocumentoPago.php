         ...
         <div class="table-responsive">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form id="form-subir-documentopago" style="padding:0px 15px;" class="form-horizontal" role="form" action="<?php echo base_url();?>Upload/subirDocumentoPago" method="POST">
                     <div class="row">
                        <div class="col-md-4">
