                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="settings">
                                            <form id="formmantencion" style="padding:0px 15px;" class="form-horizontal"
                                                role="form">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" maxlength="35"
                                                            style="text-transform:lowercase;" class="form-control"
                                                            id="servicio" placeholder="Trabajo realizado">
                                                    </div>
                                                </div>
                                 ...
                                 ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" maxlength="50"
                                                            style="text-transform:lowercase;" class="form-control"
                                                            id="mecanico" placeholder="Nombre del mecánico">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" maxlength="40"
                                                            style="text-transform:lowercase;" class="form-control"
                                                            id="taller" placeholder="Taller o planta de mantención">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <input type="number" maxlength="10"
                                                            style="text-transform:lowercase;" class="form-control"
                                                            id="total_m" placeholder="$ Costo Total">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <div class="col-md-3 text-center">
                                                        <button type="submit" id="addmantencion"
