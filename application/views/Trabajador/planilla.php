                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="price">
                                <a class="btn-solid-reg popup-with-move-anim" type="submit" href="#asistencia1">Asistencia</a>
                            </div>
                            <hr class="cell-divide-hr">
                        </div>
                    </div> <!-- end of card -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Desayuno</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Almuerzo</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Cena</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Agua</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Alojamiento</div>
                                </li>
                            </ul>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="button-wrapper">
                                <a class="btn-solid-reg page-scroll" href="#request">Ingredar</a>
                            </div>
                        </div>
                    </div> <!-- end of card -->
                    <!-- end of card -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr class="cell-divide-hr"></br></br>
                            <div class="card-subtitle">Registrar materiales utilizado de la bodega</div>
                            <hr class="cell-divide-hr">
                            
                            <div class="button-wrapper">
                                <a class="btn-solid-reg page-scroll" href="#request">Ingresar</a>
                            </div>
                        </div>
                    </div> <!-- end of card -->
                    <!-- end of card -->
